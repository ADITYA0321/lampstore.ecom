...
const BirdLampsPreview = () => {
  ...
  const previewImages = birdLampImages.slice(0, 5);

  return (
    <section className="mt-10 px-4">
      <h2 className="text-2xl font-bold mb-4">Bird Lamp Collection</h2>
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 gap-6">
        {previewImages.map((lamp) => (
...
export default BirdLampsPreview;
